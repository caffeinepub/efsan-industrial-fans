...
export class Backend implements backendInterface {
    ...
    async addBlogPost(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
    ...
    async getSortedBlogPostsByDate(): Promise<Array<BlogPost>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedBlogPostsByDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
